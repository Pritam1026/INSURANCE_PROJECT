...
class InsuranceException(Exception):
    """
    This class is used to raise custom InsuranceException
    """

    def __init__(self,error_message:Exception,error_detail:sys):
        super().__init__(error_message)
        self.error_message=InsuranceException.error_messgae_detail(error=error_message,error_detail=error_detail)

    @staticmethod
    def error_message_detail(error:Exception,error_detail:sys)->str:
        """
        error_message: Exception object raise from module
